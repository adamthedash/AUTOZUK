...
export const PLAYER_ACCURACY_TARGETS = [
  "nibbler",
  "bat",
  "blob",
  "blobletMelee",
...
export const PLAYER_ACCURACY_LABELS = {
  nibbler: "Nibbler",
  bat: "Bat",
  blob: "Blob",
...
export const INCOMING_ACCURACY_ROWS = [
...
export const DEFAULT_GEAR_CONFIGS = {
  ayak: {
...
export const MOB_TYPE_PRIORITY = {
  mager: 0,
  ranger: 1,
  meleer: 2,
  blob: 3,
